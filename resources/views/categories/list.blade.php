...
@section('content')
    <div class="be-content">
        <div class="page-head">
            <h2>{{trans('app.categories')}} Management</h2>
            <ol class="breadcrumb">
                <li><a href="{{url('/dashboard')}}">{{trans('app.admin_home')}}</a></li>
                <li class="active">{{trans('app.categories')}} Listing</li>
            </ol>
        </div>
                            ...
                            <div class="addreport pull-right">
                                <a href="{{url('/categories/add')}}">
                                    <button class="btn btn-space btn-primary"><i
                                                class="icon mdi mdi-plus "></i> {{trans('app.add')}} {{trans('app.categories')}}
                                    </button>
                                </a>
                            </div>
                        </div>
...
<script src="{{url('js/modules/categories.js')}}"></script>
@endpush
@push('internalJsLoad')
<script>
    app.categories.init();
